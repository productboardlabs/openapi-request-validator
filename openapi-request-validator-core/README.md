...
The core validator logic in the OpenAPI Request Validator.
...
See
the [examples module](https://bitbucket.org/atlassian/openapi-request-validator/src/master/openapi-request-validator-examples/?at=master)
